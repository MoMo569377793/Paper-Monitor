...
MATRIX_FREE_FEM_TOPIC_DEFAULT = {
    "id": "matrix_free_fem",
    "display_name": "有限元分析 Matrix-Free 算法优化",
    "description": "核心关注 matrix-free 有限元/谱元算子在现代硬件上的实现、优化与性能可移植。只有直接讨论 matrix-free 及其实现/性能的论文才纳入；纯数学理论或泛有限元 GPU 工作不纳入。",
    "source_queries": {
        "arxiv": [
            "all:\"matrix-free\" AND all:\"finite element\"",
            "all:\"matrix free\" AND all:\"finite element\"",
            "all:\"matrix-free operator evaluation\"",
            "all:\"matrix-free operator application\"",
            "all:\"on-the-fly operator evaluation\" AND all:\"finite element\"",
            "all:\"matrix-free\" AND all:\"sum factorization\"",
            "all:\"matrix-free\" AND all:\"spectral element\"",
            "all:\"matrix-free\" AND all:\"GPU\"",
            "all:\"matrix-free\" AND all:\"performance portability\"",
            "all:\"libCEED\" AND all:\"matrix-free\"",
        ],
        "dblp": [
            ...
            "\"on-the-fly operator evaluation\" finite element",
            "\"matrix-free\" \"sum factorization\"",
            "\"matrix-free\" \"spectral element\"",
            "\"matrix-free\" GPU",
    ...
    "required_keyword_groups": [
        [
            ...
            "on-the-fly operator evaluation",
        ],
        [
            "finite element",
            "finite elements",
    ...
    "must_match_groups": [
        ["sum factorization", "sum-factorization", "tensor contraction", "partial assembly"],
        ["libceed", "mfem", "deal.ii", "deal ii", "nekrs", "nek5000"],
        ["gpu", "cuda", "hip", "simd", "vectorization", "performance portability", "benchmark"],
    ],
    "positive_keywords": [
        "sum factorization",
        "sum-factorization",
    ...
    "dblp_venue_keywords": ["sc", "ppopp", "ipdps", "ics", "cluster", "cgo", "asplos", "parco"],
    "priority_venue_keywords": ["sc", "ppopp", "ipdps", "ics", "cluster", "cgo", "asplos", "parco"],
    "threshold": 18,
    "seed_papers": [
        {
            ...
            "primary_url": "https://doi.org/10.1016/j.compfluid.2012.04.012",
            "doi": "10.1016/j.compfluid.2012.04.012",
            "tags": ["curated-seed", "classic", "deal.ii"],
        },
        {
            ...
            "primary_url": "https://doi.org/10.1145/3325864",
            "doi": "10.1145/3325864",
            "tags": ["curated-seed", "classic", "dg"],
        },
        {
            "title": "Matrix-free finite-element computations on graphics processors with adaptive mesh refinement",
            "authors": ["Karl Ljungkvist"],
            "year": 2017,
            "venue": "Licentiate Thesis / Uppsala University",
            "tags": ["curated-seed", "classic", "gpu"],
        },
        {
            ...
            "primary_url": "https://doi.org/10.1145/3322813",
            "doi": "10.1145/3322813",
            "tags": ["curated-seed", "classic", "multigrid", "gpu"],
        },
        {
            "title": "High-performance implementation of kernel evaluations for the matrix-free operator application in the DG context",
            "authors": ["Steffen Müthing", "Piotr Piatkowski", "Peter Bastian"],
            "year": 2017,
        ...
        },
        {
            ...
            "authors": ["Paul Fischer", "Stefan Kerkemeier", "Misun Min"],
            "year": 2022,
            "venue": "Parallel Computing",
            "primary_url": "https://doi.org/10.1016/j.parco.2022.102982",
            "doi": "10.1016/j.parco.2022.102982",
            "tags": ["curated-seed", "spectral-element", "gpu"],
        },
        {
            "title": "The deal.II Library, Version 9.7",
            "authors": ["David Arndt", "Wolfgang Bangerth", "Martin Kronbichler"],
            "year": 2025,
            "venue": "Journal of Numerical Mathematics",
            "primary_url": "https://doi.org/10.1515/jnma-2025-0115",
            "doi": "10.1515/jnma-2025-0115",
            "tags": ["curated-seed", "framework"],
        },
        {
            "title": "High-performance finite elements with MFEM",
            "authors": ["Julian Andrej", "Veselin Dobrev", "Tzanio Kolev"],
            "year": 2024,
            "venue": "International Journal of High Performance Computing Applications",
            "primary_url": "https://doi.org/10.1177/10943420241261981",
            "doi": "10.1177/10943420241261981",
            "tags": ["curated-seed", "framework", "mfem"],
        },
        {
            ...
            "tags": ["curated-seed", "classic", "sum-factorization-origin"],
        },
    ],
}

AI_OPERATOR_ACCELERATION_TOPIC_DEFAULT = {
    "id": "ai_operator_acceleration",
    "display_name": "AI 算子加速",
    "description": "核心关注深度学习工作负载中的算子实现与系统级性能优化，包括 GEMM/matmul、attention 内核、kernel fusion、Tensor Core / ARM SVE/SME 利用、AI 编译器与训练/推理框架性能工程。纯算法或模型设计论文不纳入。",
    "source_queries": {
        "arxiv": [
            "all:\"GEMM optimization\"",
            "all:\"matmul optimization\"",
            "all:\"matrix multiplication\" AND all:\"optimization\"",
            "all:\"FlashAttention\"",
            "all:\"kernel fusion\" AND all:\"deep learning\"",
            "all:\"operator fusion\" AND all:\"inference\"",
            "all:\"Tensor Core\" AND all:\"GEMM\"",
            "all:\"Triton\" AND all:\"compiler\"",
            "all:\"TVM\" AND all:\"deep learning\"",
            "all:\"MLIR\" AND all:\"deep learning\"",
            "all:\"ARM SVE\" AND all:\"GEMM\"",
            "all:\"ARM SME\" AND all:\"GEMM\"",
            "all:\"CUTLASS\"",
        ],
        "dblp": [
            "\"GEMM optimization\"",
            ...
            "\"operator fusion\" inference",
            "\"Tensor Core\" GEMM",
            "Triton compiler deep learning",
            "TVM optimizing compiler deep learning",
        ...
        "google_scholar_alerts": [
            "\"GEMM optimization\" deep learning",
            "\"matrix multiplication\" optimization transformer",
            "\"FlashAttention\"",
    ...
    "must_match_groups": [
        ["gpu", "cuda", "tensor core", "wmma", "mma", "arm", "sve", "sme"],
        ["triton", "tvm", "mlir", "xla", "halide", "inductor", "cutlass"],
        ["benchmark", "roofline", "scaling", "throughput", "latency", "memory bandwidth"],
    ],
    "positive_keywords": [
        "cutlass",
        "triton",
    ...
    "dblp_venue_keywords": ["mlsys", "ppopp", "sc", "isca", "micro", "asplos", "osdi", "sosp", "hpca", "cgo"],
    "priority_venue_keywords": ["mlsys", "ppopp", "sc", "isca", "micro", "asplos", "osdi", "sosp", "hpca", "cgo"],
    "threshold": 18,
    "seed_papers": [
        {
            ...
            "year": 2022,
            "venue": "NeurIPS / arXiv",
            "primary_url": "https://arxiv.org/abs/2205.14135",
            "arxiv_id": "2205.14135",
            "tags": ["curated-seed", "flashattention"],
        },
        {
            ...
            "year": 2023,
            "venue": "arXiv",
            "primary_url": "https://arxiv.org/abs/2307.08691",
            "arxiv_id": "2307.08691",
            "tags": ["curated-seed", "flashattention"],
        },
        {
        ...
        },
        {
            ...
            "year": 2019,
            "venue": "MPC / arXiv",
            "tags": ["curated-seed", "triton"],
        },
        {
            "title": "CUTLASS: Fast Linear Algebra in CUDA C++",
            "year": 2017,
            "venue": "NVIDIA Technical Blog / Documentation",
            "primary_url": "https://developer.nvidia.com/blog/cutlass-linear-algebra-cuda/",
            "tags": ["curated-seed", "cutlass"],
        },
        {
            "title": "TVM: An Automated End-to-End Optimizing Compiler for Deep Learning",
            "authors": ["Tianqi Chen", "Thierry Moreau", "Ziheng Jiang"],
            "year": 2018,
            "venue": "OSDI",
            "tags": ["curated-seed", "tvm"],
        },
        {
            "title": "MLIR: Scaling Compiler Infrastructure for Domain Specific Computation",
            "authors": ["Chris Lattner", "Mehdi Amini", "Uday Bondhugula"],
            "year": 2021,
            "venue": "CGO",
            "primary_url": "https://doi.org/10.1109/CGO51591.2021.9370308",
            "doi": "10.1109/CGO51591.2021.9370308",
            "tags": ["curated-seed", "mlir"],
        },
        {
            "title": "Halide: A Language and Compiler for Optimizing Parallelism, Locality, and Recomputation in Image Processing Pipelines",
            "authors": ["Jonathan Ragan-Kelley", "Andrew Adams", "Sylvain Paris"],
            "year": 2013,
            "venue": "PLDI",
            "primary_url": "https://doi.org/10.1145/2491956.2462176",
            "doi": "10.1145/2491956.2462176",
            "tags": ["curated-seed", "halide"],
        },
        {
            "title": "Kernel Fusion: An Effective Method for Better Power Efficiency on Multithreaded GPU",
            "authors": ["Peng Wang"],
            "year": 2010,
            "venue": "curated classic",
            "tags": ["curated-seed", "kernel-fusion"],
        },
        {
            ...
            "primary_url": "https://doi.org/10.1145/1498765.1498785",
            "doi": "10.1145/1498765.1498785",
            "tags": ["curated-seed", "roofline"],
        },
    ],
}

TOPIC_PRESETS = {
    MATRIX_FREE_FEM_TOPIC_DEFAULT["id"]: MATRIX_FREE_FEM_TOPIC_DEFAULT,
    AI_OPERATOR_ACCELERATION_TOPIC_DEFAULT["id"]: AI_OPERATOR_ACCELERATION_TOPIC_DEFAULT,
}
...
DEFAULT_CONFIG = {
    ...
    "llm_variants": [],
    "topics": [MATRIX_FREE_FEM_TOPIC_DEFAULT, AI_OPERATOR_ACCELERATION_TOPIC_DEFAULT],
}
...
def _build_topic_config(raw: dict) -> TopicConfig:
    topic_id = str(raw.get("id", ""))
    preset = TOPIC_PRESETS.get(topic_id)
    if preset and "required_keyword_groups" not in raw:
        raw = dict(preset)
    elif preset:
        merged = dict(preset)
        merged.update(raw)
    ...
    return TopicConfig(
        ...
        source_queries={
            str(source_name): [str(query) for query in queries]
            for source_name, queries in dict(raw.get("source_queries", {})).items()
        },
        required_keyword_groups=[
        ...
        must_match_groups=[
            [str(keyword) for keyword in group]
            for group in raw.get("must_match_groups", [])
        ],
        positive_keywords=[str(keyword) for keyword in raw.get("positive_keywords", [])],
        exclude_keywords=[str(keyword) for keyword in raw.get("exclude_keywords", [])],
        arxiv_categories=[str(item) for item in raw.get("arxiv_categories", [])],
        priority_arxiv_categories=[str(item) for item in raw.get("priority_arxiv_categories", [])],
        dblp_venue_keywords=[str(item) for item in raw.get("dblp_venue_keywords", [])],
        priority_venue_keywords=[str(item) for item in raw.get("priority_venue_keywords", [])],
        threshold=float(raw.get("threshold", 18.0)),
        seed_papers=[
            SeedPaperConfig(
                ...
                primary_url=str(item.get("primary_url", "")),
            ...
            for item in raw.get("seed_papers", [])
        ],
    )
...
def load_settings(config_path: str | Path) -> Settings:
    ...
    topics = [_build_topic_config(topic_raw) for topic_raw in raw.get("topics", [])]
    if not topics:
